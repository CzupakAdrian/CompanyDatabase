...
from database_objects.Objects import InsurerLocal
import pandas as pd
...
class InsurerTest(DbConnection):
    ...
    def addInsurers(self):
        self.session.add(InsurerLocal(id=2, name="AXA"))
        self.session.add(InsurerLocal(id=3, name="PZU"))
        self.session.add(InsurerLocal(id=4, name="XCR"))
        self.session.add(InsurerLocal(id=5, name="TYIU"))
        self.session.add(InsurerLocal(id=6, name="PIIK"))
        self.session.add(InsurerLocal(id=7, name="ADAE"))
        self.session.add(InsurerLocal(id=8, name="RADAD"))
        self.session.add(InsurerLocal(id=9, name="ADD"))
        self.session.add(InsurerLocal(id=10, name="GITI"))
        self.session.commit()
...
if __name__ == '__main__':
    ...
    # testInstance.session.add(InsurerLocal(id=2, name="ALLA"))
